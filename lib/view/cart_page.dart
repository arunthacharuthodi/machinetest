...
class CartPage extends StatefulWidget {
  ...
  // CartPage({required this.category_name});
...
class _CartPageState extends State<CartPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<CartProvider>(context, listen: false).cartFromDb();
    });
  }

  @override
  Widget build(BuildContext context) {
    final product_data = Provider.of<CartProvider>(context);
    ...
    return Scaffold(
        ...
        body: !product_data.is_cartloading
            ? GridView.builder(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        product_data.product_list[index].title,
